...
export default function FinishRDScreen({ navigation }) {
  ...
  return (
    <ImageBackground 
      source={require('../assets/WT1.png')} // Background image for the FinishRDScreen
...
const styles = StyleSheet.create({
  ...
  container: {
    ...
    paddingBottom: 50, // Add padding to prevent the button from being too close to the bottom
  },
  title: {
    fontSize: 28,
    marginBottom: 20,
